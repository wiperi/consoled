...
def main():
    ...
    print("\n==========================================")
    skip_color = YELLOW if fail_count else ''
    end_color = NC if fail_count else ''
    print(f"  Sync completed! ({GREEN}{success_count} succeeded{NC}, "
          f"{skip_color}{fail_count} skipped{end_color})")
    print("==========================================")
