...
|-|-|-|-|
| Heartbeat Scalability | Verify system handles 48 ports heartbeat concurrently | 48 serial ports with active heartbeat monitoring for 60s | Avg CPU < 50%; Memory stable; All ports report correct oper_state |
| Data Transfer Scalability | Verify system handles 48 ports data transfer concurrently | 48 serial ports with continuous data transfer for 60s | Avg CPU < 75%; Memory stable; No data corruption |
